...
public class PlayersFinderTest {
    ...
    public void findPlayers1() {
        ...
        String photo[] = {"8D88888J8L8E888",
                ...
                "U88H8NI8CZB88B8",
                "8PK8H8T8888TQR8"};
                Point[] expected = new Point[]{new Point(1, 17), new Point(3, 3), new Point(3, 10), new Point(3, 25),
                new Point(5, 21), new Point(8, 17), new Point(9, 2), new Point(10, 9),
                new Point(12, 23), new Point(17, 16), new Point(18, 3),
                new Point(18, 11), new Point(18, 28), new Point(22, 20), new Point(23, 26), new Point(24, 15),
                new Point(27, 2), new Point(28, 26), new Point(29, 16)};

                Point actual [] =  playersFinder.findPlayers(photo, 8, 9);
    ...
    public void findPlayers2(){
        ...
        Point actual [] = playersFinder.findPlayers(photo,3,16);
        assertArrayEquals(expected,actual);
    }
    @org.junit.Test
    public void findPlayers3(){
        ...
        Point expected [] = new Point[] {new Point(3,8), new Point(4,16), new Point(5,4),new Point (16,3),new Point (16,17),new Point (17,9)};
        Point actual [] = playersFinder.findPlayers(photo,4,16);
        assertArrayEquals(expected,actual);
    }
    @org.junit.Test
    public void findPlayers4(){
        ...
        Point actual [] = playersFinder.findPlayers(photo,1,3);
        assertArrayEquals(expected,actual);
    }
    @Test
    ...
    public void iceHockeyTest2() {
        IPlayersFinder playersFinder = new PlayersFinder();
        final String[] image = {
                "3",
                "3",
                "3",
